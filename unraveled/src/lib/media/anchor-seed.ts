...
export const ANCHOR_MEDIA: AnchorMediaSeed[] = [
  ...
  {
    anchor_key: 'jre-2051-graham-hancock',
    type: 'spotify_podcast',
    title: 'Joe Rogan Experience #2051 — Graham Hancock',
    description: 'Hancock\'s post-Ancient Apocalypse JRE appearance, covering America Before, the Younger Dryas impact, Göbekli Tepe, and the evidence for a pre-12,000 BCE advanced civilization. Recorded after the Netflix series aired.',
    url: 'https://open.spotify.com/episode/5jVsWOz8sYZ09ZBbk1EtpQ',
    embed_url: 'https://open.spotify.com/embed/episode/5jVsWOz8sYZ09ZBbk1EtpQ',
  ...
  {
    anchor_key: 'jre-1897-hancock-carlson',
    type: 'spotify_podcast',
    title: 'Joe Rogan Experience #1897 — Graham Hancock & Randall Carlson',
    description: 'A landmark reunion episode bringing lost civilization and catastrophism back to mainstream audiences. Hancock and Carlson revisit the Younger Dryas impact, flood mythology, and the missing civilization hypothesis with updated evidence.',
    url: 'https://open.spotify.com/episode/2xvmTo09BFMd6tJfJPmmvT',
    embed_url: 'https://open.spotify.com/embed/episode/2xvmTo09BFMd6tJfJPmmvT',
    thumbnail_url: 'https://i.scdn.co/image/ab6765630000ba8a0af9f9adb78cf8c89b40a83d',
    channel_name: 'Joe Rogan Experience',
    channel_url: 'https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk',
  ...
  {
    anchor_key: 'jre-1284-graham-hancock',
    type: 'spotify_podcast',
    title: 'Joe Rogan Experience #1284 — Graham Hancock',
    ...
    url: 'https://open.spotify.com/episode/28NjcnhgduoERiKLaIYO4x',
    embed_url: 'https://open.spotify.com/embed/episode/28NjcnhgduoERiKLaIYO4x',
    thumbnail_url: 'https://i.scdn.co/image/ab6765630000ba8a0af9f9adb78cf8c89b40a83d',
    channel_name: 'Joe Rogan Experience',
    channel_url: 'https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk',
    guest_names: ['Graham Hancock'],
  ...
  {
    anchor_key: 'jre-606-randall-carlson',
    type: 'spotify_podcast',
    title: 'Joe Rogan Experience #606 — Randall Carlson',
    description: 'Carlson\'s breakout solo JRE appearance. Deep dive into Missoula Floods, cosmic cycles, Younger Dryas catastrophe, and the geological evidence for a civilization-ending impact event.',
    url: 'https://open.spotify.com/episode/0Sfwu85dxXHsz9VLoDTnie',
    embed_url: 'https://open.spotify.com/embed/episode/0Sfwu85dxXHsz9VLoDTnie',
    thumbnail_url: 'https://i.scdn.co/image/ab6765630000ba8a0af9f9adb78cf8c89b40a83d',
    channel_name: 'Joe Rogan Experience',
    channel_url: 'https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk',
  ...
  {
    anchor_key: 'jre-872-hancock-carlson',
    type: 'spotify_podcast',
    title: 'Joe Rogan Experience #872 — Graham Hancock & Randall Carlson',
    description: 'An earlier landmark episode with Hancock and Carlson covering the Younger Dryas impact, lost civilizations, ancient maps, and the geological record of catastrophic flooding — before either became household names in alternative history.',
    url: 'https://open.spotify.com/episode/7s5FNLNjizgPAfNmfo03rt',
    embed_url: 'https://open.spotify.com/embed/episode/7s5FNLNjizgPAfNmfo03rt',
    thumbnail_url: 'https://i.scdn.co/image/ab6765630000ba8a0af9f9adb78cf8c89b40a83d',
    channel_name: 'Joe Rogan Experience',
    channel_url: 'https://open.spotify.com/show/4rOoJ6Egrf8K2IrywzwOMk',
    guest_names: ['Graham Hancock', 'Randall Carlson'],
    key_claims: [
      { claim: 'Piri Reis map shows accurate coastlines that were only accessible before Antarctic ice sheets formed', timestamp: '0:45:00' },
      { claim: 'Younger Dryas Boundary layer marks a global catastrophe 12,900 years ago', timestamp: '1:20:00' },
    ],
    timestamp_markers: [
      { time: '0:40:00', description: 'Ancient maps and pre-ice age cartography' },
      { time: '1:15:00', description: 'Younger Dryas impact evidence' },
      { time: '2:00:00', description: 'Gobekli Tepe and the unknown builders' },
    ],
    ...
    channel_subscriber_count: null,
    topics: ['global flood', 'lost civilizations', 'catastrophism'],
    tags: ['hancock', 'carlson', 'younger dryas', 'flood', 'lost civilization', 'ancient maps', 'göbekli tepe'],
    sort_order: 25,
    approved: true,
    featured: false,
  },
