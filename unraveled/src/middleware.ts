...
const PUBLIC_PATH_PREFIXES = [
  ...
  '/api/submissions',
  '/api/graph',
  '/api/ratings',      // GET (averages) is public; POST enforced at route level
  '/sitemap.xml',
  '/robots.txt',
];
...
export async function middleware(request: NextRequest) {
  ...
  // Build a cookie-aware Supabase client to refresh the session
  ...
  // Refresh session (rotates cookies if needed)
  ...
  // Public content — let through regardless of auth
